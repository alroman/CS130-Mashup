...
$client_id     = '121701154606843'; # the application ID
$client_secret = '9375f40fc20e1a2025adff48d9f5154c';
$callbackURL   = 'http://localhost/CS130-Mashup/web/application/views/example.facebook.oauth.php'; # The URL of this script when you place it on your server, so that facebook will know where to redirect the user back
$extendedPermissions = 'user_likes,publish_stream,create_event,manage_pages,offline_access'; # see http://developers.facebook.com/docs/authentication/permissions
...
if($_SESSION['loggedin']) {
	...
	$response = xhttp::fetch('https://graph.facebook.com/'.$data.'/likes');
...
<p>
	<h3><?php echo $_SESSION['user']['name'] ?> (User)</h3>
        <input value="<php echo  htmlspecialchars($_SESSION['user']['likes']) ?>"
